...
This example is for illustration purposes only; most new programmers in Rust will fall into a few common traps which we shall mention here, and fix later.
